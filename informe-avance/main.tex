...
%%%%%%%%%%%%%%%%% INDICES %%%%%%%%%%%%%%%%%
\setstretch{1}
\vspace*{\fill} %%%%%% PARA ELIMINAR EL ESPACIO SUPERIOR COMENTAR ESTA LINEA
...
%%%%%%%%%%%%%%%%% CONTENIDO %%%%%%%%%%%%%%%%%
\newpage
\input{content/pregunta_investigacion}
\input{content/fuente_y_consideraciones_eticas}
\input{content/eda}
\input{content/plan_modelamiento}
