...
Enfoque Descriptivo (Énfasis en la interpretación causal y biológica)
Este enfoque es ideal para aislar el efecto de una variable en particular, "congelando" matemáticamente el resto.
\subsection{Pregunta de Investigación}
(El impacto de la grasa abdominal): ¿En qué medida la circunferencia de la cintura explica los niveles de colesterol total en adultos estadounidenses, una vez que se controla el efecto de la edad, el sexo y el nivel socioeconómico (ratio de pobreza)?

Por qué es buena: Te permite discutir el concepto estadístico de "controlar por variables". Puedes contrastar un modelo simple (solo cintura) versus el modelo múltiple completo, y usar el Test F Parcial para demostrar si las variables de control realmente eran necesarias.
...
VARIABLE DEPENDIENTE: COLESTEROL TOTAL
